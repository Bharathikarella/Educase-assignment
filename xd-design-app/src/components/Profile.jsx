    ...
    <div className="min-h-screen flex justify-center items-start p-4 bg-white">
      <div className="w-[375px] h-[712px] bg-white border border-gray-300 flex flex-col">
        <div className="px-4 py-3">
          <h2 className="text-[16px]  text-left font-medium text-[#1D2226]">Account Settings</h2>
        </div>
        ...
        <div className="bg-[#F7F8F9] flex-1 px-4 py-5 relative">
          ...
          <p className="mt-4 text-[14px] text-[#1D2226] text-justify font-normal leading-snug capitalize">
            Lorem Ipsum Dolor Sit Amet, Consetetur Sadipscing Elitr, 
            Sed Diam Nonumy Eirmod Tempor Invidunt Ut Labore Et Dolore Magna Aliquam Erat, Sed Diam
          </p>
